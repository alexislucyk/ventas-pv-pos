...
<body>
    ...
    <div class="content">
        <div style="display: flex; justify-content: space-between; align-items: center;">
            ...
            <a href="presupuestos.php" class="btn-success" style="text-decoration:none; padding:10px;">+ Nuevo Presupuesto</a>
        </div>
    ...
    <div style="background-color: #252525; margin: 5% auto; padding: 20px; border: 1px solid #444; width: 70%; border-radius: 8px; color: white;">
        <div style="display: flex; justify-content: space-between; align-items: center; border-bottom: 1px solid #444; pb-10px; margin-bottom: 20px;">
            <h2 id="modalTitulo">Presupuesto #</h2>
