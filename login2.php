...
<?php
// 1. Iniciar la sesión al principio (SIN llamar a infosesion.php)
session_start();

// Opcional: Si el usuario YA está logueado y entra al login, 
// lo mandamos al index para que no tenga que loguearse de nuevo
